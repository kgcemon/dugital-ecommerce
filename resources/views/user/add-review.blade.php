...
<div class="container">
    ...
    <div class="selection-panel" data-step="1">
        ...
        <div style="display:flex;gap:8px;font-size:1.5rem;cursor:pointer;">
            ⭐ ⭐ ⭐ ⭐ ⭐
        </div>
    </div>
    ...
    <!-- Submit -->
    <button class="checkout-btn">Submit Review</button>

    <!-- Success / Error Example -->
    <div class="response-box success" style="margin-top:20px;display:none">
        ✅ Thank you for your feedback!
    </div>
    <div class="response-box error" style="margin-top:20px;display:none">
