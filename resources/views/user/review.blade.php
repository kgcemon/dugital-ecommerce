...
<div class="container">
    ...
    <div class="review-card">
        <div class="review-avatar">
            <img src="https://i.pravatar.cc/100?img=12" alt="John">
        </div>
        <div class="review-content">
            ...
            <p class="review-text">Absolutely amazing sound quality! I use it daily for gaming.</p>
        </div>
    </div>
    ...
    <div class="review-card">
        ...
        <div class="review-content">
            ...
            <div class="review-stars">⭐ ⭐ ⭐ ⭐</div>
            <p class="review-text">Very comfortable and clear mic. The only downside is the long delivery time.</p>
        </div>
    </div>
    ...
    <div class="review-card">
        <div class="review-avatar">
            <img src="https://i.pravatar.cc/100?img=9" alt="Alex">
        </div>
        <div class="review-content">
            <div class="review-header">
                <span class="review-name">Alex R.</span>
                <span class="review-date">3 weeks ago</span>
            </div>
            <div class="review-stars">⭐ ⭐ ⭐</div>
            <p class="review-text">Good headset overall but I expected deeper bass.</p>
        </div>
    </div>
